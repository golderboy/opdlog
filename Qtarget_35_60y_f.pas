...
type
  Ttarger_35_60y_form = class(TForm)
    ...
    Qtarget_30_60y: TMyQuery;
    Dtarget_30_60y: TMyDataSource;
...
var
  targer_35_60y_form: Ttarger_35_60y_form;
...
procedure Ttarger_35_60y_form.excel_export_btnClick(Sender: TObject);
begin
...
function Ttarger_35_60y_form.GetTempDir: string;
var
...
procedure Ttarger_35_60y_form.post_date_btnClick(Sender: TObject);
begin
  Qtarget_30_60y.Close;
  Qtarget_30_60y.Params.ParamValues['year'] := list_year.Text ;
  Qtarget_30_60y.Open;
  record_count.Caption :=  IntToStr(Qtarget_30_60y.RecordCount);
  Qtarget_30_60y.First;
        process_Qrb1k.Position := 0;
        process_Qrb1k.properties.Max := Qtarget_30_60y.RecordCount;
           while not Qtarget_30_60y.Eof do
              begin
                Qtarget_30_60y.Next;
                //sleep(1000);
...
procedure Ttarger_35_60y_form.RzBitBtn1Click(Sender: TObject);
begin
close;
end;
