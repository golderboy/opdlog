object target_women_form: Ttarget_women_form
  Left = 0
  Top = 0
  Caption = 'target_women'
  ClientHeight = 532
  ClientWidth = 767
  Color = clBtnFace
  ...
  object header_opdlog: TJvNavPanelHeader
    ...
    Height = 33
    Align = alTop
    Caption = '  '#3648#3611#3657#3634#3627#3617#3634#3618#3627#3597#3636#3591#3623#3633#3618#3648#3592#3619#3636#3597#3614#3633#3609#3608#3660
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -16
    Font.Name = 'Arial'
  ...
  object show_visit: TcxGrid
    ...
    object show_visitDBTableView1: TcxGridDBTableView
      ...
      DataController.DataSource = Dtarget_women
  ...
  object Qtarget_women: TMyQuery
    ...
    SQL.Strings = (
      ...
      'pt.birthday,if(pt.sex = 2,'#39#3627#3597#3636#3591#39','#39#39') as sex,'
      ...
      ''
        ...
        'WHERE pt.birthday BETWEEN concat(@years-50,'#39'1001'#39') AND concat(@y' +
        'ears-15,'#39'0930'#39')'
      
        '#WHERE pt.birthday BETWEEN concat(2016-50,'#39'1001'#39') AND concat(201' +
        '6-15,'#39'0930'#39')'
      'AND pt.sex = 2'
  ...
  object Dtarget_women: TMyDataSource
    DataSet = Qtarget_women
    Left = 424
    Top = 168
  end
end
