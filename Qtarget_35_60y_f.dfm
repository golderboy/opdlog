object targer_35_60y_form: Ttarger_35_60y_form
  Left = 0
  Top = 0
  Caption = 'targer_35_60y_form'
  ClientHeight = 537
  ClientWidth = 764
  Color = clBtnFace
  ...
  object header_opdlog: TJvNavPanelHeader
    ...
    Height = 33
    Align = alTop
    Caption = '  '#3648#3611#3657#3634#3627#3617#3634#3618'NCD 35 - 60 '#3611#3637
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -16
    Font.Name = 'Arial'
  ...
  object show_visit: TcxGrid
    ...
    object show_visitDBTableView1: TcxGridDBTableView
      ...
      DataController.DataSource = Dtarget_30_60y
  ...
  object Qtarget_30_60y: TMyQuery
    SQLInsert.Strings = (
    ...
    SQL.Strings = (
      ...
      ''
        ...
        'WHERE pt.birthday BETWEEN concat(@years-60,'#39'1001'#39') AND concat(@y' +
        'ears-35,'#39'0930'#39')'
  ...
  object Dtarget_30_60y: TMyDataSource
    DataSet = Qtarget_30_60y
    Left = 424
    Top = 168
  end
end
