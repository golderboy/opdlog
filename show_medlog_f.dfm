object show_med_form: Tshow_med_form
  Left = 0
  Top = 0
  Caption = 'show_med_form'
  ClientHeight = 502
  ClientWidth = 744
  Color = clBtnFace
  ...
  object show_visit: TcxGrid
    ...
    object show_visitDBTableView1: TcxGridDBTableView
      ...
      DataController.DataSource = data_med
      ...
      object show_visitDBTableView1license_number: TcxGridDBColumn
        DataBinding.FieldName = 'license_number'
        Width = 101
      end
  ...
  object Qshow_med: TMyQuery
    ...
    SQL.Strings = (
        ...
        '  vt.visit_type_name,pw.`name` as pt_walk_name,pt.pttype,pt.`nam' +
        'e`,'
      '  v.pdx,doc.health_med_doctor_name as doctor,doc.license_number,'
      
        '  oc.height,oc.bw,oc.waist,oc.bmi,oc.bpd,oc.bps,oc.bw,oc.hr,oc.p' +
        'e,oc.pulse,oc.rr,oc.temperature,oc.cc,oc.hpi,oc.pmh,'
      
        '  GROUP_CONCAT(item.health_med_treatment_type_name) as treatment' +
        ',k.department'
      
        '                                                                ' +
        '               '
      '  from health_med_service med  '
      
        '  LEFT OUTER JOIN ovst_doctor_sign ods on ods.vn = med.vn       ' +
        '                                                                ' +
        '             '
      '  left outer join vn_stat v on v.vn=med.vn '
      
        '  left outer join ovst as o on o.vn = med.vn                    ' +
        '                                                        '
      ...
      '  left outer join opdscreen oc on oc.vn=med.vn   '
      '  left outer join pt_walk pw on pw.walk_id = oc.walk_id  '
      '  left outer join visit_type vt on vt.visit_type = o.visit_type'
      
        '  left outer join health_med_doctor doc on doc.health_med_doctor' +
        '_id = med.health_med_doctor_id'
      
        '  LEFT outer JOIN health_med_treatment_type item on item.health_' +
        'med_treatment_type_id = med.health_med_treatment_type_id'
      ' '
