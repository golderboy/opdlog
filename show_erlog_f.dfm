object erlog_form: Terlog_form
  ...
  object show_visit: TcxGrid
    ...
    object show_visitDBTableView1: TcxGridDBTableView
      ...
      DataController.DataSource = data_erlog
  ...
  object Qshow_erregis: TMyQuery
    ...
    SQL.Strings = (
        ...
        'ulse,oc.rr,oc.temperature,'
      
        '  oc.cc,oc.hpi,oc.pmh,erl.er_list,peri.`name` as er_period,ept.`' +
        'name` as er_pt_type,eme.`name` as er_emergency_type,  '
      '  k.department,GROUP_CONCAT(oq.doctor_list_text) as doctor_list'
  ...
  object data_erlog: TMyDataSource
    DataSet = Qshow_erregis
    Left = 424
    Top = 168
  end
end
