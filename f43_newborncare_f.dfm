object f43_newborncare_form: Tf43_newborncare_form
  Left = 0
  Top = 0
  Caption = 'f43_newborncare_form'
  ClientHeight = 547
  ClientWidth = 779
  Color = clBtnFace
  ...
  object show_visit: TcxGrid
    ...
    object show_visitDBTableView1: TcxGridDBTableView
      ...
      DataController.DataSource = Df43_newbornCare
  ...
  object Qf43_newbornCare: TMyQuery
    SQLInsert.Strings = (
    ...
    SQL.Strings = (
      ...
      'pws.vn AS SEQ, '
        ...
        'IF(p.birthdate IS NULL OR TRIM(p.birthdate)='#39#39' OR p.birthdate LI' +
        'KE '#39'0000-00-00%'#39','#39#39',DATE_FORMAT(p.birthdate,'#39'%Y%m%d'#39')) AS BDATE,' +
        ' '
      
        'IF(pbc.care_date IS NULL OR TRIM(pbc.care_date)='#39#39' OR pbc.care_d' +
        'ate LIKE '#39'0000-00-00%'#39','#39#39',DATE_FORMAT(pbc.care_date,'#39'%Y%m%d'#39'))AS' +
        ' BCARE,'
      ...
      'ELSE '#39'9'#39'  END )AS BCARERESULT,'
      'pbc.person_nutrition_food_type_id AS FOOD,'
      
        '(SELECT cid FROM doctor WHERE pbc.doctor_code = doctor.`code`)AS' +
        ' PROVIDER,'
      
        'IF(pw.last_update IS NULL OR TRIM(pw.last_update)='#39#39' OR pw.last_' +
        'update LIKE '#39'0000-00-00%'#39','#39#39',DATE_FORMAT(pw.last_update,'#39'%Y%m%d%' +
      ...
      'FROM  person_wbc_post_care pbc'
        ...
        'LEFT OUTER JOIN person_wbc pw ON pw.person_wbc_id = pbc.person_w' +
        'bc_id'
      
        'LEFT OUTER JOIN person_wbc_service pws ON pws.person_wbc_id=pbc.' +
        'person_wbc_id'
      'LEFT OUTER JOIN person p ON pw.person_id=p.person_id'
      ''
      '#WHERE pbc.care_date between 20160501 AND 20160530'
      'where pbc.care_date BETWEEN :date_start_text AND :date_end_text'
  ...
  object Df43_newbornCare: TMyDataSource
    DataSet = Qf43_newbornCare
    Left = 424
    Top = 168
  end
end
