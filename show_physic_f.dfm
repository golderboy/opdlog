object show_physic_form: Tshow_physic_form
  Left = 0
  Top = 0
  Caption = 'show_physic_form'
  ClientHeight = 534
  ClientWidth = 777
  Color = clBtnFace
  ...
  object show_visit: TcxGrid
    ...
    object show_visitDBTableView1: TcxGridDBTableView
      ...
      DataController.DataSource = data_physic
      ...
      object show_visitDBTableView1Physic_name: TcxGridDBColumn
        DataBinding.FieldName = 'Physic_name'
        Width = 87
      end
      ...
      object show_visitDBTableView1Item_list: TcxGridDBColumn
        DataBinding.FieldName = 'Item_list'
        Width = 228
      end
  ...
  object Qshow_physic: TMyQuery
    ...
    SQL.Strings = (
        ...
        ','
      '  phg.physic_group_name as Physic_name,'
      
        '  oc.height,oc.bw,oc.waist,oc.bmi,oc.bpd,oc.bps,oc.bw,oc.hr,oc.p' +
        'e,oc.pulse,oc.rr,oc.temperature,oc.cc,oc.hpi,oc.pmh,  '
      
        '  v.pdx,GROUP_CONCAT(DISTINCT(pht.`name`)) as Item_list,sum(pht.' +
        'price) as physic_money,k.department'
      
        '                                                                ' +
        '               '
      '  from physic_list phy  '
      
        '  LEFT OUTER JOIN ovst_doctor_sign ods on ods.vn = phy.vn       ' +
        '                                                                ' +
        '             '
      '  left outer join vn_stat v on v.vn=phy.vn '
      
        '  left outer join ovst as o on o.vn = phy.vn                    ' +
        '                                                        '
      ...
      '  left outer join opdscreen oc on oc.vn=phy.vn   '
      '  left outer join pt_walk pw on pw.walk_id = oc.walk_id  '
      '  left outer join visit_type vt on vt.visit_type = o.visit_type'
      
        '  left outer join physic_items pht on pht.physic_items_id = phy.' +
        'physic_items_id'
      
        '  LEFT outer JOIN physic_group phg on phg.physic_group_id = phy.' +
        'physic_group_id'
      ' '
      '  where v.vstdate between :date_start_text AND :date_end_text'
      '  #where v.vstdate between 20160301 AND 20160331'
  ...
  object data_physic: TMyDataSource
    DataSet = Qshow_physic
    Left = 424
    Top = 168
  end
end
