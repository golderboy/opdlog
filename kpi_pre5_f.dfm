object kpi_pre5_form: Tkpi_pre5_form
  Left = 0
  Top = 0
  Caption = 'kpi_pre5_form'
  ClientHeight = 555
  ClientWidth = 791
  Color = clBtnFace
  ...
  object header_opdlog: TJvNavPanelHeader
    ...
    Height = 33
    Align = alTop
    Caption = '  '#3613#3634#3585#3588#3619#3619#3606#3660#3588#3619#3610' 5 '#3588#3619#3633#3657#3591#3651#3609#3611#3637
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -16
    Font.Name = 'Arial'
  ...
  object show_visit: TcxGrid
    ...
    object show_visitDBTableView1: TcxGridDBTableView
      ...
      object show_visitDBTableView1person_anc_id: TcxGridDBColumn
        Caption = 'anc_id'
        DataBinding.FieldName = 'person_anc_id'
        Width = 46
      end
  ...
  object Qkpi_pre5: TMyQuery
    ...
    SQL.Strings = (
      ...
      ''
        ...
        'on_anc_id = a.person_anc_id AND precare_no = 1))as pp1,'
      
        'if(a.pre_labor_service2_date is not null,a.pre_labor_service2_da' +
        'te,(select precare_date from person_anc_other_precare where pers' +
        'on_anc_id = a.person_anc_id AND precare_no = 2))as pp2,'
      
        'if(a.pre_labor_service3_date is not null,a.pre_labor_service3_da' +
        'te,(select precare_date from person_anc_other_precare where pers' +
        'on_anc_id = a.person_anc_id AND precare_no = 3))as pp3,'
      
        'if(a.pre_labor_service4_date is not null,a.pre_labor_service4_da' +
        'te,(select precare_date from person_anc_other_precare where pers' +
        'on_anc_id = a.person_anc_id AND precare_no = 4))as pp4,'
      
        'if(a.pre_labor_service5_date is not null,a.pre_labor_service5_da' +
        'te,(select precare_date from person_anc_other_precare where pers' +
        'on_anc_id = a.person_anc_id AND precare_no = 5))as pp5'
      ''
  ...
  object Dkpi_pre5: TMyDataSource
    DataSet = Qkpi_pre5
    Left = 424
    Top = 168
  end
