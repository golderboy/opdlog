object targer_60y_form: Ttarger_60y_form
  Left = 0
  Top = 0
  Caption = 'targer_60y_form'
  ClientHeight = 543
  ClientWidth = 774
  Color = clBtnFace
  ...
  object header_opdlog: TJvNavPanelHeader
    ...
    Height = 33
    Align = alTop
    Caption = '  '#3648#3611#3657#3634#3627#3617#3634#3618'NCD  60 '#3611#3637' '#3586#3638#3657#3609#3652#3611
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -16
    Font.Name = 'Arial'
  ...
  object show_visit: TcxGrid
    ...
    object show_visitDBTableView1: TcxGridDBTableView
      ...
      DataController.DataSource = Dtarget_60y
  ...
  object Qtarget_60y: TMyQuery
    ...
    SQL.Strings = (
      ...
      'from patient as pt '
        ...
        'pt.cid'
      'LEFT OUTER JOIN clinicmember as c  ON c.hn = p.patient_hn'
      'LEFT OUTER JOIN clinic as n ON c.clinic = n.clinic'
      
        'LEFT OUTER JOIN clinic_member_status cm ON cm.clinic_member_stat' +
        'us_id = c.clinic_member_status_id  '
      'LEFT OUTER JOIN sys_var as s ON c.clinic = s.sys_value'
      ''
      'WHERE pt.birthday >= concat(@years-61,'#39'0930'#39')'
      'AND p.house_regist_type_id in (1,3)'
      'AND pt.hn not in (select hn from death)'
      'AND pt.hn not in ('
      'select c.hn from clinicmember as c'
      'LEFT OUTER JOIN clinic as n ON c.clinic = n.clinic'
      ...
      'LEFT OUTER JOIN sys_var as s ON c.clinic = s.sys_value'
        ...
        'WHERE s.sys_name in('#39'dm_clinic_code'#39','#39'ht_clinic_code'#39','#39'tb_clinic' +
        '_code'#39','#39'copd_clinic_code'#39','#39'asthma_clinic_code'#39')'
      ')'
      ''
  ...
  object Dtarget_60y: TMyDataSource
    DataSet = Qtarget_60y
    Left = 424
    Top = 168
  end
