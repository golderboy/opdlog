object f43_drugal_form: Tf43_drugal_form
  Left = 0
  Top = 0
  Caption = 'f43_drugal_form'
  ClientHeight = 537
  ClientWidth = 769
  Color = clBtnFace
  ...
  object show_visit: TcxGrid
    ...
    object show_visitDBTableView1: TcxGridDBTableView
      ...
      object show_visitDBTableView1TYPEDX: TcxGridDBColumn
        DataBinding.FieldName = 'TYPEDX'
        Width = 60
      end
      ...
      object show_visitDBTableView1SYMPTOM: TcxGridDBColumn
        DataBinding.FieldName = 'SYMPTOM'
      end
      ...
      object show_visitDBTableView1INFORMHOSP: TcxGridDBColumn
        DataBinding.FieldName = 'INFORMHOSP'
        Width = 96
      end
  ...
  object Qf43_drug: TMyQuery
    ...
    SQL.Strings = (
      ...
      'IFNULL(pe.person_id,pt.hn) AS PID,'
        ...
        'IF(oe.report_date IS NULL OR TRIM(oe.report_date)='#39' '#39' OR oe.repo' +
        'rt_date LIKE '#39'0000-00-00%'#39','#39#39',DATE_FORMAT(oe.report_date,'#39'%Y%m%d' +
        #39')) AS DATERECORD,'
      ''
      ...
      '(SELECT CASE'
        ...
        'WHEN oe.allergy_relation_id IN ('#39'1'#39','#39'2'#39','#39'3'#39','#39'4'#39','#39'5'#39') THEN oe.all' +
        'ergy_relation_id'
      ...
      #39#39' AS INFORMANT,'
        ...
        '(SELECT DISTINCT opdconfig.hospitalcode FROM opdconfig) AS INFOR' +
        'MHOSP,'
      
        'If(oe.update_datetime IS NULL OR TRIM(oe.update_datetime) = '#39#39' O' +
        'R oe.update_datetime LIKE '#39'0000-00-00%'#39', '#39#39', DATE_FORMAT(oe.upda' +
        'te_datetime,'#39'%Y%m%d%H%i%s'#39')) AS D_UPDATE,'
      'pt.cid AS CID,'
      ...
      'LEFT JOIN patient pt ON oe.hn=pt.hn'
        ...
        'LEFT OUTER JOIN person pe ON oe.hn = pe.patient_hn AND pt.hn = p' +
        'e.patient_hn AND pt.cid = pe.cid'
      '#WHERE oe.report_date Between 20160701 AND 20160731'
      'WHERE oe.report_date Between :date_start_text AND :date_end_text'
      ''
  ...
  object Df43_drug: TMyDataSource
    DataSet = Qf43_drug
    Left = 424
    Top = 168
  end
