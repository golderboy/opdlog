object f43_accident_form: Tf43_accident_form
  Left = 0
  Top = 0
  Caption = 'f43_accident_form'
  ClientHeight = 523
  ClientWidth = 764
  Color = clBtnFace
  ...
  object show_visit: TcxGrid
    ...
    object show_visitDBTableView1: TcxGridDBTableView
      ...
      object show_visitDBTableView1DATETIME_SERV: TcxGridDBColumn
        DataBinding.FieldName = 'DATETIME_SERV'
        Width = 119
      end
  ...
  object Qf43_accident: TMyQuery
    ...
    SQL.Strings = (
      ...
      'v.vn AS SEQ,'
        ...
        'IF(er.enter_er_time IS NULL OR TRIM(er.enter_er_time)='#39#39' OR er.e' +
        'nter_er_time LIKE '#39'0000-00-00%'#39','#39#39',DATE_FORMAT(er.enter_er_time,' +
        #39'%Y%m%d%H%i%s'#39')) AS DATETIME_SERV,'
      
        'IF(er.enter_er_time IS NULL OR TRIM(er.enter_er_time)='#39#39' OR er.e' +
        'nter_er_time LIKE '#39'0000-00-00%'#39','#39#39',DATE_FORMAT(er.enter_er_time,' +
        #39'%Y%m%d%H%i%s'#39')) AS DATETIME_AE,'
      'CASE LENGTH(r.er_accident_type_id )'
      'WHEN 1 THEN CONCAT('#39'0'#39',r.er_accident_type_id)'
      'ELSE r.er_accident_type_id END AS AETYPE,'
      'CASE LENGTH(r.accident_place_type_id )'
      'WHEN 1 THEN CONCAT('#39'0'#39',r.accident_place_type_id)'
      'ELSE r.accident_place_type_id END AS AEPLACE,'
      'IF(r.visit_type IS NOT NULL,r.visit_type,9) AS TYPEIN_AE,'
      
        'IF(r.accident_person_type_id IS NOT NULL,r.accident_person_type_' +
        'id,9)  AS TRAFFIC,'
      
        'IF(r.accident_transport_type_id IS NOT NULL,r.accident_transport' +
        '_type_id,99) AS  VEHICLE,'
      ...
      'WHEN  '#39'1'#39' THEN  '#39'2'#39
      'WHEN  '#39'2'#39' THEN  '#39'3'#39
      'WHEN  '#39'3'#39' THEN  '#39'4'#39
      'WHEN  '#39'4'#39' THEN  '#39'5'#39
      'WHEN  '#39'5'#39' THEN  '#39'1'#39
      'ELSE '#39'6'#39' END ) AS URGENCY,'
      'r.gcs_e AS COMA_EYE,'
      'r.gcs_v AS COMA_SPEAK,'
      'r.gcs_m AS COMA_MOVEMENT,'
      
        'IF(er.finish_time IS NULL OR TRIM(er.finish_time)='#39#39' OR er.finis' +
        'h_time LIKE '#39'0000-00-00%'#39','#39#39',DATE_FORMAT(er.finish_time,'#39'%Y%m%d%' +
  ...
  object Df43_accident: TMyDataSource
    DataSet = Qf43_accident
    Left = 424
    Top = 168
  end
end
