object target_0_5y_form: Ttarget_0_5y_form
  Left = 0
  Top = 0
  Caption = 'target_0_5y_form'
  ClientHeight = 546
  ClientWidth = 780
  Color = clBtnFace
  ...
  object header_opdlog: TJvNavPanelHeader
    ...
    Height = 33
    Align = alTop
    Caption = '  '#3648#3611#3657#3634#3627#3617#3634#3618#3648#3604#3655#3585' 0 - 5 '#3611#3637
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -16
    Font.Name = 'Arial'
  ...
  object show_visit: TcxGrid
    ...
    object show_visitDBTableView1: TcxGridDBTableView
      ...
      DataController.DataSource = Dtarget_0_5y
      ...
      object show_visitDBTableView1status_p: TcxGridDBColumn
        DataBinding.FieldName = 'status_p'
        Width = 68
      end
  ...
  object Qtarget_0_5y: TMyQuery
    ...
    SQL.Strings = (
      ...
      'concat('
        ...
        'if(pt.birthday BETWEEN concat(@years-2,'#39'1001'#39') AND concat(@years' +
        ','#39'0930'#39'),'#39#3594#3656#3623#3591' 0-1 '#3611#3637#39','#39#39'),'
      
        'if(pt.birthday BETWEEN concat(@years-3,'#39'1001'#39') AND concat(@years' +
        '-2,'#39'0930'#39'),'#39#3594#3656#3623#3591' 2 '#3611#3637#39','#39#39'),'
      
        'if(pt.birthday BETWEEN concat(@years-4,'#39'1001'#39') AND concat(@years' +
        '-3,'#39'0930'#39'),'#39#3594#3656#3623#3591' 3 '#3611#3637#39','#39#39'),'
      
        'if(pt.birthday BETWEEN concat(@years-5,'#39'1001'#39') AND concat(@years' +
        '-4,'#39'0930'#39'),'#39#3594#3656#3623#3591' 4 '#3611#3637#39','#39#39'),'
      
        'if(pt.birthday BETWEEN concat(@years-6,'#39'1001'#39') AND concat(@years' +
        '-5,'#39'0930'#39'),'#39#3594#3656#3623#3591' 5 '#3611#3637#39','#39#39')'
      ')as status_p,'
      ...
      ''
        ...
        'WHERE pt.birthday BETWEEN concat(@years-6,'#39'1001'#39') AND concat(@ye' +
        'ars,'#39'0930'#39')'
  ...
  object Dtarget_0_5y: TMyDataSource
    DataSet = Qtarget_0_5y
    Left = 424
    Top = 168
  end
end
